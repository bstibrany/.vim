...
if has("gui_running") || &t_Co == 256
    ...
    hi Keyword cterm=NONE ctermfg=215 ctermbg=16 gui=NONE guifg=#ffaf5f guibg=#000000
    hi Constant cterm=NONE ctermfg=252 ctermbg=16 gui=NONE guifg=#d0d0d0 guibg=#000000
    hi String cterm=NONE ctermfg=69 ctermbg=16 gui=NONE guifg=#5f87ff guibg=#000000
    hi Comment cterm=NONE ctermfg=240 ctermbg=16 gui=NONE guifg=#585858 guibg=#000000
    hi Number cterm=NONE ctermfg=69 ctermbg=16 gui=NONE guifg=#5f87ff guibg=#000000
    ...
    hi Keyword cterm=NONE ctermfg=LightBrown ctermbg=Black
    hi Constant cterm=NONE ctermfg=Gray ctermbg=Black
    hi String cterm=NONE ctermfg=LightBlue ctermbg=Black
    hi Comment cterm=NONE ctermfg=DarkGray ctermbg=Black
    hi Number cterm=NONE ctermfg=LightBlue ctermbg=Black
